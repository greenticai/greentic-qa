...
LOCALE="${LOCALE:-en}"
EN_PATH="${EN_PATH:-crates/qa-cli/i18n/en.json}"
...
Environment overrides:
  EN_PATH=...                     English source file path (default: crates/qa-cli/i18n/en.json)
...
Examples:
  ...
  EN_PATH=crates/qa-cli/i18n/en.json tools/i18n.sh validate
EOF
}
